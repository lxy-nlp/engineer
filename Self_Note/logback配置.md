...
## logback配置
### springboot中的配置
[配置详解](https://www.cnblogs.com/warking/p/5710303.html)
springboot 会自动识别 src/main/resources/conf 下的logback.xml 并加载
...
# 日志框架 
[日志框架详解](https://juejin.cn/post/6905026199722917902)
## 规约
不可直接使用日志系统（Log4j，LogBack）中的API，应该依赖日志框架SLF4J中的API，使用门面模式的日志框架，有利于维护各个类的日志统一方式
## SLF4J
![SLF4J](_v_images/20220802204609331_668946789.png)
